 ...
 * Generated at: 2020-08-07 02:07:17 UTC
...
public final class selectBookmark_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/store/../member/sideMenu.jsp", Long.valueOf(1596518241671L));
  }
...
if(loginStore == null){ 
      ...
      out.print(request.getContextPath());
      out.write("/member/selectBookmark.do\" method=\"POST\"\r\n");
      out.write("                onsubmit=\"return validate();\">\r\n");
      out.write("                    <h1>즐겨찾기</h1>\r\n");
      ...
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t<p><span class=\"ico-star1\">★ ");
      ...
      out.write("\t\t<div class=\"col-md-6\">\r\n");
      out.write("\t\t\t<div\r\n");
      out.write("\t\t\t\tclass=\"row no-gutters border rounded overflow-hidden flex-md-row mb-6 shadow-sm h-md-250 position-relative\">\r\n");
      out.write("\t\t\t\t<div class=\"col p-4 d-flex flex-column position-static\">\r\n");
      out.write("\t\t\t\t\t    <strong class=\"d-inline-block mb-2 text-primary\">");
      out.print(store.getStoreGroupName());
      out.write("</strong>\r\n");
