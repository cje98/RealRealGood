 ...
 * Generated at: 2020-08-07 00:03:51 UTC
...
public final class review_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/board/../common/header.jsp", Long.valueOf(1596758426391L));
    _jspx_dependants.put("/WEB-INF/views/board/../common/footer.jsp", Long.valueOf(1596758426319L));
  }
...
int readCountAdd = Integer.parseInt(request.getParameter("readCountAdd"));
...
if(loginStore == null){ 
      ...
      out.write("      }\r\n");
      out.write("\r\n");
      out.write("            .trans6:hover{\r\n");
      out.write("                transform: scale(4,4);\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
 ...
 if(reviewList != null) { 
      ...
      out.write("\t  <div class=\"card-deck mb-3 text-center\" style=\"height: 500px\">\r\n");
      out.write("\t    <div class=\"card mb-4 shadow-sm\">\r\n");
      out.write("\t      <div class=\"card-header\" >\r\n");
      out.write("\t        <div class=\"ReviewCard__UserInfo\">\r\n");
      out.write("\t            <span class=\"ReviewCard__UserName\" style=\"text-align: left\"> 작성자 :  ");
      out.print(reviewList.getNickName() );
      out.write("</span>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t          <div class=\"ReviewCard__CountInfo\" style=\"text-align: left\" >\r\n");
      ...
      out.write("        <h6 class=\"card-title pricing-card-title\" style=\"text-align: left;\">조회수 :  ");
      out.print(readCountAdd );
      out.write(" <small class=\"text-muted\"></small></h6>\r\n");
      out.write("        <div class=\"list-unstyled mt-3 mb-4\"  style=\"text-align: left\" style=\"margin-top: 20px\">\r\n");
 ...
 if(fileList != null){ 
      ...
      out.write(" \t  \r\n");
      out.write("\t\t\t <div style=\"width: 120px; height: 120px; display : inline-block\">\r\n");
      out.write("\t\t\t    <img class=\"trans6\" width=\"100%\" height=\"100%\" src=\"");
      out.print( src );
      out.write("\" />\r\n");
      ...
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("\t<div class=\"test\" style=\"display: inline-block; margin-left: 58%\">\r\n");
      out.write("\t\t\t");
 if(loginMember != null && (reviewList.getNickName().equals(loginMember.getNickName()  ))) {
      ...
      out.write("&storeNo=");
      out.print(storeNum);
      out.write("\" class=\"btn btn-primary float-right\">삭제</a> \r\n");
      out.write("\t\t\t<a href=\"");
      out.print(request.getContextPath());
      out.write("/board/updateForm.do?boardNo=");
      out.print(boardNo);
      out.write("&storeNum=");
      out.print(storeNum);
      ...
      out.write("\t\treturn confirm(\"정말로 삭제 하시겠습니까?\");\r\n");
      out.write("\t});\r\n");
      out.write("   \t</script>\r\n");
      out.write("   \t\r\n");
      out.write("\t\t<script src=\"https://code.jquery.com/jquery-3.5.1.min.js\"></script>\r\n");
